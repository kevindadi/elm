...
namespace elm
{
	...
	namespace intern
	{
		...
		struct is_scalar
		{
			enum
			{
				_ = sizeof(test_class<T>(0)) != sizeof(char)
			};
		};
	}
	...
	// generic class
	template <class T>
	class type_info : public default_t
	{
	public:
		enum
		{
		...
		enum
		{
			is_enum = intern::is_scalar<T>::_
		};
		enum
		{
			is_scalar = intern::is_scalar<T>::_
		};
	...
	// bool specialization
	template <>
	struct type_info<bool> : public scalar_t<bool>
	{
	...
	// void specialization
	template <>
	struct type_info<void> : public default_t
	{
		enum
		{
			is_void = 1
	...
	template <class I>
	const I signed_info<I>::null;
	template <class I>
	const I signed_info<I>::min = I(-1) << (sizeof(I) * 8 - 1);
	template <class I>
	const I signed_info<I>::max = ~(I(-1) << (sizeof(I) * 8 - 1));
	...
	template <class I>
	const I unsigned_info<I>::null;
	template <class I>
	const I unsigned_info<I>::min;
	template <class I>
	const I unsigned_info<I>::max;

	template <>
	struct type_info<char> : public signed_info<char>
	{
		static cstring name(void);
		static const int shift = 0;
	};
	template <>
	struct type_info<t::int8> : public signed_info<t::int8>
	{
		static cstring name(void);
		static const int shift = 0;
	};
	template <>
	struct type_info<t::uint8> : public unsigned_info<t::uint8>
	{
		static cstring name(void);
		static const int shift = 0;
	};
	template <>
	struct type_info<t::int16> : public signed_info<t::int16>
	{
		static cstring name(void);
		static const int shift = 1;
	};
	template <>
	struct type_info<t::uint16> : public unsigned_info<t::uint16>
	{
		static cstring name(void);
		static const int shift = 1;
	};
	template <>
	struct type_info<t::int32> : public signed_info<t::int32>
	{
		static cstring name(void);
		static const int shift = 2;
	};
	template <>
	struct type_info<t::uint32> : public unsigned_info<t::uint32>
	{
		static cstring name(void);
		static const int shift = 2;
	};
	template <>
	struct type_info<t::int64> : public signed_info<t::int64>
	{
		static cstring name(void);
		static const int shift = 3;
	};
	template <>
	struct type_info<t::uint64> : public unsigned_info<t::uint64>
	{
		static cstring name(void);
		static const int shift = 3;
	};
	...
	template <>
	struct type_info<float> : public scalar_t<float>
	{
	...
	template <>
	struct type_info<double> : public scalar_t<double>
	{
	...
	template <>
	struct type_info<long double> : public scalar_t<long double>
	{
	...
	template <>
	struct type_info<cstring> : public default_t
	{
	...
	template <>
	struct type_info<string> : public default_t
	{
	...
	template <class T>
	struct type_info<const T *> : public scalar_t<const T *>
	{
		typedef T of;
		enum
		{
	...
	template <class T>
	const T *const type_info<const T *>::null = nullptr;

	template <class T>
	struct type_info<T *> : public scalar_t<T *>
	{
		typedef T of;
		enum
		{
	...
	template <class T>
	T *const type_info<T *>::null = nullptr;
	...
	template <class T>
	struct type_info<const T &> : public ref_t<const T>
	{
		typedef T of;
		enum
		{
	...
	template <class T>
	struct type_info<T &> : public ref_t<T>
	{
		typedef T of;
		enum
		{
	...
	namespace t
	{
		...
		template <class T>
		inline void put(var<T> &x, in<T> v) { type_info<T>::put(x, v); }
		template <class T>
		inline ret<T> get(const var<T> &v) { return type_info<T>::get(v); }
		template <class T>
		inline mut<T> ref(var<T> &x) { return type_info<T>::ref(x); }
	} // t
